...
static oqs_nid_name_t nid_names[NID_TABLE_LEN] = {
  ...
  { 0, "p256_efrodo640aes", OQS_KEM_alg_efrodokem_640_aes, KEY_TYPE_ECP_HYB_KEM , 128, 0 },
  { 0, "x25519_efrodo640aes", OQS_KEM_alg_efrodokem_640_aes,   KEY_TYPE_ECX_HYB_KEM  , 128, 0 },
  { 0, "efrodo640shake", OQS_KEM_alg_efrodokem_640_shake, KEY_TYPE_KEM, 128, 0 },
  { 0, "p256_efrodo640shake", OQS_KEM_alg_efrodokem_640_shake, KEY_TYPE_ECP_HYB_KEM , 128, 0 },
  { 0, "x25519_efrodo640shake", OQS_KEM_alg_efrodokem_640_shake,   KEY_TYPE_ECX_HYB_KEM  , 128, 0 },
  { 0, "efrodo976aes", OQS_KEM_alg_efrodokem_976_aes, KEY_TYPE_KEM, 192, 0 },
  { 0, "p384_efrodo976aes", OQS_KEM_alg_efrodokem_976_aes, KEY_TYPE_ECP_HYB_KEM , 192, 0 },
  { 0, "x448_efrodo976aes", OQS_KEM_alg_efrodokem_976_aes,   KEY_TYPE_ECX_HYB_KEM  , 192, 0 },
  { 0, "efrodo976shake", OQS_KEM_alg_efrodokem_976_shake, KEY_TYPE_KEM, 192, 0 },
  { 0, "p384_efrodo976shake", OQS_KEM_alg_efrodokem_976_shake, KEY_TYPE_ECP_HYB_KEM , 192, 0 },
  { 0, "x448_efrodo976shake", OQS_KEM_alg_efrodokem_976_shake,   KEY_TYPE_ECX_HYB_KEM  , 192, 0 },
  { 0, "efrodo1344aes", OQS_KEM_alg_efrodokem_1344_aes, KEY_TYPE_KEM, 256, 0 },
  { 0, "p521_efrodo1344aes", OQS_KEM_alg_efrodokem_1344_aes, KEY_TYPE_ECP_HYB_KEM , 256, 0 },
  { 0, "efrodo1344shake", OQS_KEM_alg_efrodokem_1344_shake, KEY_TYPE_KEM, 256, 0 },
  { 0, "p521_efrodo1344shake", OQS_KEM_alg_efrodokem_1344_shake, KEY_TYPE_ECP_HYB_KEM , 256, 0 },
  ...
  { 0, "p521_bikel5", OQS_KEM_alg_bike_l5, KEY_TYPE_ECP_HYB_KEM , 256, 0 },
       ...
       { 0, "slhdsashake192f", OQS_SIG_alg_slh_dsa_pure_shake_192f, KEY_TYPE_SIG, 192 },
       { 0, "slhdsashake256s", OQS_SIG_alg_slh_dsa_pure_shake_256s, KEY_TYPE_SIG, 256 },
